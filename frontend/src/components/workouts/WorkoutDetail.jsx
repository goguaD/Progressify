          ...
          <div className="workout-detail-hero-overlay">
            ...
            <div className="workout-detail-meta">
              <span className="workout-meta-pill">
                📅 {plan.days_per_week}× / {t.workouts_week || 'week'}
              </span>
              <span className="workout-meta-pill">
                🎯 {t[`workouts_level_${plan.level}`] || plan.level}
              </span>
              <span className="workout-meta-pill">
            ...
            {onRate && (
              <div className="workout-detail-my-rating">
                <span className="workout-detail-my-label">
                  {t.workouts_your_rating || 'Your rating:'}
                </span>
                <StarRating
          ...
          {onAddToProfile && (
            <div className="workout-detail-add-row">
              <button
                ...
                onClick={() => onAddToProfile(plan)}
              >
                {isActive
                  ? (t.workouts_replace_active || '🔁 Replace active plan')
                  : (t.workouts_add_to_profile || '➕ Add this plan to my profile')}
              </button>
              {isActive && (
                <span className="workout-detail-active-flag">
                  {t.workouts_active_plan || '✓ Currently active'}
                </span>
              )}
            </div>
          )}

          <RepRangeLegend t={t} appLang={appLang} />
            ...
            <div className="workout-day-content">
              ...
              <div className="workout-exercises">
                {day.exercises.map(ex => (
                  <ExerciseCard key={ex.id} ex={ex} t={t} appLang={appLang} gender={gender} />
                ))}
              </div>
            </div>
          )}
